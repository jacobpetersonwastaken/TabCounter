...
const firebaseConfig = {
    apiKey: "AIzaSyACSoZBjVuZha6kk85HFZIp6e8_XJv7OQk",
    authDomain: "tabcounter-56092.firebaseapp.com",
    databaseURL: "https://tabcounter-56092-default-rtdb.firebaseio.com",
    projectId: "tabcounter-56092",
    storageBucket: "tabcounter-56092.appspot.com",
    messagingSenderId: "332696864945",
    appId: "1:332696864945:web:422dbef1e119e9da2f7a90",
    measurementId: "G-578PMC3D9K"
};
...
function writeUserData() {
    console.log("we are writting data")
...
chrome.runtime.onMessage.addListener(function(message, sender, resp) {
    if (message.command === "yup") {
        console.log("fucking hell")
            // writeUserData()
        resp({ farewell: "goodbye" });
        return true;
